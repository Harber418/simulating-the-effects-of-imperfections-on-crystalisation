...
def generate_lammps(lx=30, ly=30, nbead=1000, seed=8263444,
...
if __name__ == "__main__":
    ...
    generate_lammps(lx=30.3,ly=30.3, mean=1.0, sd=0.096, filename="lammps_input_pd", statsfile="type_stats.txt")