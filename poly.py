...
def generate_lammps(lx=30, ly=30, nbead=1000, seed=21622,
...
if __name__ == "__main__":
    generate_lammps(lx=29.7,ly=29.7, mean=1.0, sd=0.07, filename="lammps_input_pd", statsfile="type_stats.txt")
